...
const songsList = [
  {
    name: "Make Me Move",
    link: "./src/sounds/make-me-move.mp3",
    artist: "Culture Code",
    image: "./src/img/make-me-move.jpg",
  },
  {
    name: "Where We Started",
    link: "./src/sounds/where-we-started.mp3",
    artist: "Lost Sky",
    image: "./src/img/where-we-started.jpg",
  },
  {
    name: "On & On",
    link: "./src/sounds/on-on.mp3",
    artist: "Cartoon",
    image: "./src/img/on-on.jpg",
  },
  {
    name: "Throne",
    link: "./src/sounds/throne.mp3",
    artist: "Rival",
    image: "./src/img/throne.jpg",
  },
  {
    name: "Need You Now",
    link: "./src/sounds/need-you-now.mp3",
    artist: "Venemy",
    image: "./src/img/need-you-now.jpg",
  },
];
